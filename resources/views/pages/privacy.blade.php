...
<div class="app-container py-4 vstack gap-4 pb-5" style="max-width:48rem;">
    ...
    <div class="pt-4">
        <h1 class="fs-3 fw-bold mb-1">Política de Privacidade</h1>
    ...
    <div class="card"><div class="card-body p-4 p-sm-5 small text-secondary-emphasis lh-base">
        ...
        <section class="mb-4">
            <h2 class="fw-semibold fs-6 mb-2">1. Recolha de Dados</h2>
        ...
        <section class="mb-4">
            <h2 class="fw-semibold fs-6 mb-2">2. Uso dos Dados</h2>
        ...
        <section class="mb-4">
            <h2 class="fw-semibold fs-6 mb-2">3. Dados Públicos</h2>
        ...
        <section class="mb-4">
            <h2 class="fw-semibold fs-6 mb-2">4. Cookies</h2>
        ...
        <section class="mb-4">
            <h2 class="fw-semibold fs-6 mb-2">5. Segurança</h2>
        ...
        <section class="mb-4">
            <h2 class="fw-semibold fs-6 mb-2">6. Retenção de Dados</h2>
        ...
        <section class="mb-4">
            <h2 class="fw-semibold fs-6 mb-2">7. Os Seus Direitos</h2>
            <p>Tem direito a:</p>
            <ul class="mb-2">
            ...
            <p>Para exercer estes direitos, contacte-nos através da <a href="{{ route('contact') }}" class="link-primary text-decoration-none">página de contacto</a>.</p>
        </section>

        <section class="mb-4">
            <h2 class="fw-semibold fs-6 mb-2">8. Alterações a esta Política</h2>
